...
Hooks.once("init", async function () {
  ...
  Actors.registerSheet(systemName, InvestigatorPCSheetClass, {
    makeDefault: true,
    types: [pc],
  });
  Actors.registerSheet(systemName, InvestigatorNPCSheetClass, {
    makeDefault: true,
    types: [npc],
  });
  Actors.registerSheet(systemName, InvestigatorPartySheetClass, {
    makeDefault: true,
    types: [party],
  });
  Items.unregisterSheet("core", ItemSheet);
  Items.registerSheet(systemName, InvestigatorEquipmentSheetClass, {
    makeDefault: true,
    types: [weapon, equipment],
  });
  Items.registerSheet(systemName, InvestigatorAbilitySheetClass, {
    makeDefault: true,
    types: [investigativeAbility, generalAbility],
  });
  Items.registerSheet(systemName, InvestigatorMwItemSheetClass, {
    makeDefault: true,
    types: [mwItem],
  });
