...
describe("pipe", () => {
  ...
  test("v1toV2", () => {
    expect(v1toV2(v1)).toEqual({ member2: 2 });
  });
  test("v2toV3", () => {
    expect(v2toV3(v2)).toEqual({ member3: 3 });
  });
  test("v3toV4", () => {
    expect(v3toV4(v3)).toEqual({ member4: 4 });
  });
  test("v4toV5", () => {
    expect(v4toV5(v4)).toEqual({ member5: 5 });
  });
  test("v2toV5", () => {
    expect(v2toV5(v2)).toEqual({ member5: 5 });
  });
  test("v1toV5", () => {
    expect(v1toV5(v1)).toEqual({ member5: 5 });
  });
});
...
describe("chainPipe", () => {
  ...
  test("v3toV5", () => {
    expect(v3toV5(v3)).toEqual({ member5: 5 });
  });
  test("v4toV5", () => {
    expect(v4toV5(v4)).toEqual({ member5: 5 });
  });
