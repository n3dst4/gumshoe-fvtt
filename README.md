...
![A screenshot of two character sheets in different styles, one for a Trail of Cthulhu character called Kath Hulu, and one for a Night's Black Agents character called Neil Athertep](./screenshot.webp "Screenshot")
...
3. Where it says **Manfest URL**, paste in
    ...
    ```
    https://gitlab.com/n3dst4/gumshoe-fvtt/-/raw/master/src/system.json
    ```
